...
namespace DVLD_project.Controls
{
    public partial class ctrlPersonCardWithFilter : UserControl
    {
        ...
        public int PersonID
        {
            get { return ctrPersonDetails1.SelectedPersonID; }
        }

        /*public clsPerson SelectedPersonInfo
        {
            get { return ctrPersonDetails1.se; }
        }
*/
        ...
        private void FindNow()
        {
            ...
            if (OnPersonSelected != null && FilterEnabled)
                ...
                OnPersonSelected(ctrPersonDetails1.SelectedPersonID);
        }

        private void cbFilterBy_SelectedIndexChanged(object sender, EventArgs e)
        {
            ctrPersonDetails1.Text = "";
            ctrPersonDetails1.Focus();
        }
        ...
        private void txtFilterValue_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(ctrPersonDetails1.Text.Trim()))
            {
                e.Cancel = true;
