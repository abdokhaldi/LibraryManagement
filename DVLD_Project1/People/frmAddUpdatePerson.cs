...
namespace DVLD_Project.People
{
    public partial class frmAddUpdatePerson : Form
    {
        ...
        public frmAddUpdatePerson(int PeronID)
        {
            InitializeComponent();
            _Mode = enMode.Update;
            _PersonID = PeronID;
        ...
        private void _ResetDefaultValues()
        {
            ...
            //hide/show the remove linke
            llRemoveImage.Visible = (pbPersonImage.ImageLocation != null);

            //set the max date to 18 years from today
        ...
        private void txtNationalNo_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel= true;
                errorProvider1.SetError(txtNationalNo, "this fiels is required");
                return;
            }
            else
            {
