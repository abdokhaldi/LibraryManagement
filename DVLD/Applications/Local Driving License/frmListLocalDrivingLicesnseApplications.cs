...
namespace DVLD.Tests
{
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void _ColumnHeaderSettings(DataGridView dataGrid, int[] width, string[] headerText)
        {
            if (dataGrid.Rows.Count > 0)
            {
                for (int i = 0; i < dataGrid.ColumnCount; i++)
                {
                    ...
                    dataGrid.Columns[i].Width = width[i];
                }
            }
        }
        ...
        private void frmListLocalDrivingLicesnseApplications_Load(object sender, EventArgs e)
        {
           ...
           _ColumnHeaderSettings(
              dgvLocalDrivingLicenseApplications,
              new int[] { 120, 300, 150, 350, 170, 150,100 },
              new string[] { "L.D.L.AppID", "Driving Class", "National No.", "Full Name", "Application Date", "Passed Tests","Status" }
              );
